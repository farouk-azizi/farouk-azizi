...
- 🎓 Élève ingénieur à **ESPRIT** (Tunisie) — spécialisation **IT Infrastructure & Cloud Computing** (programme ArcTIC, accrédité CTI France & EUR-ACE®)
...
![Wazuh](https://img.shields.io/badge/Wazuh_SIEM-005571?style=flat)
...
|---|---|---|---|
| 🔧 [devsecops-pipeline-lab](https://github.com/farouk-azizi/devsecops-pipeline-lab) | Pipeline CI/CD sécurisé de bout en bout : SAST, DAST, secrets scanning, SBOM, signature d'images, déploiement K8s avec policies | GitHub Actions · Semgrep · Trivy · ZAP · Kyverno | 🚧 En construction |
| 🛡️ [wazuh-siem-lab](https://github.com/farouk-azizi/wazuh-siem-lab) | Lab SIEM/XDR reproductible as-code : 15+ attaques simulées, 5 règles de détection custom, mapping MITRE ATT&CK | Wazuh · Sysmon · Ansible · Kali | 🚧 Documentation en cours |
| 🏴 [ctf-writeups](https://github.com/farouk-azizi/ctf-writeups) | Write-ups détaillés : privesc Linux/Windows, Active Directory, web exploitation | TryHackMe · HTB | 🚧 En rédaction |
| ☁️ [cloud-infra-lab](https://github.com/farouk-azizi/cloud-infra-lab) | Cloud privé OpenStack + cluster Kubernetes bare-metal, provisioning Ansible, monitoring Prometheus/Grafana | OpenStack · K8s · Ansible | 🚧 Documentation en cours |
...
![Top Langs](https://github-readme-stats.vercel.app/api/top-langs/?username=farouk-azizi&layout=compact&theme=github_dark&hide_border=true)
